...
class MainWindow(QWidget):
    ...
    def get_frame(self):
        ...
        frame = QImage(frame, *self.dimensions, QImage.Format_RGB888).rgbSwapped()
        # paintWindow = QImage(paintWindow, *self.dimensions, QImage.Format_RGB888).rgbSwapped()
        pixmap = QPixmap.fromImage(frame)
        # pixmap2 = QPixmap.fromImage(paintWindow)
        self.pixmapItem.setPixmap(pixmap)
        # self.pixmap2Item.setPixmap(pixmap2)
